  ...
  return (
    <div className="bg-gray-700">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-3xl md:text-4xl text-center font-medium text-gray-100 mb-12 flex items-center justify-center gap-2">
          <Paw className="w-8 h-8 text-gray-200"/>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <div className="flex flex-col items-center rounded-xl">
            ...
            <Link
              to="/products"
              className="inline-block bg-blue-500 text-gray-200 px-6 py-2 rounded-xl font-medium 
